...
const UserForm = ({ onUserCreated }) => {
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-4">Create New User</h2>
      
      <form onSubmit={handleSubmit} className="flex flex-col md:flex-row md:items-end gap-4">
        <div className="flex-1">
          <label htmlFor="newUserName" className="block text-gray-700 text-sm mb-1">
            Name
          </label>
          <input 
            type="text" 
        ...
        <div className="flex-1">
          <label htmlFor="newUserEmail" className="block text-gray-700 text-sm mb-1">
        ...
        <div className="flex-1">
          <label htmlFor="newUserRole" className="block text-gray-700 text-sm mb-1">
