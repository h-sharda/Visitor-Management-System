...
const RoleSelector = ({ userId, initialRole, onRoleChange, getRoleColorClass }) => {
  ...
  return (
    <select
      className={`role-dropdown rounded text-sm border border-gray-300 px-2 py-1 ${colorClass} ${isLoading ? 'opacity-50' : ''}`}
      value={role}
