  ...
  try {
    ...
    users.forEach((user) => {
      ...
      row.innerHTML = `
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <select class="role-dropdown rounded text-sm border border-gray-300 px-2 py-1 bg-${getRoleColor(
                      user.role
                    )}-100 text-${getRoleColor(user.role)}-800" 
                ...
                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                    <button class="text-red-600 hover:text-red-900 p-1 rounded hover:bg-red-100 btn-press-effect" onclick="window.deleteUserConfirm('${
                      user._id
                    }')">
